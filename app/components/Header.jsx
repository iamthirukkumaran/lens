...
import { Search, ShoppingBag, Heart, Menu, X, LogOut, ChevronDown, LayoutDashboard, User } from 'lucide-react'
          ...
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {isDropdownOpen && (
                  <div className="absolute top-full left-0 mt-2 w-48 bg-white/95 backdrop-blur-sm rounded-lg shadow-xl border border-gray-100 py-2 z-[9999]">
              ...
              {/* {user?.role === 'admin' && (
                <Link href="/admin/dashboard" className="text-blue-600 hover:text-blue-700 font-medium transition flex items-center gap-1">
            ...
            <div className="flex items-center gap-2 lg:gap-4">
              ...
              <Link href="/search" className="hidden sm:flex text-gray-700 hover:text-gray-900 transition">
                <Search size={20} />
              </Link>

              {/* Favorites - Only show if logged in, hidden on small screens */}
              {user && (
                <Link href="/favorites" className="hidden sm:flex relative text-gray-700 hover:text-red-500 transition">
                  <Heart size={20} />
                  {favorites.length > 0 && (
              ...
              {user && (
                <Link href="/checkout" className="hidden sm:flex relative text-gray-700 hover:text-gray-900 transition">
                  <ShoppingBag size={20} />
                  {cartItems.length > 0 && (
              ...
              {!user ? (
                <Link href="/login" className="hidden sm:block px-4 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition">
                  Login
                </Link>
              ) : (
